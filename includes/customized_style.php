...
$list_templates = array( 'template-1' => get_option( 'a3_rslider_template_1' , __( 'Default Skin', 'a3_responsive_slider' ) ) );
...
.a3-rslider-<?php echo $template_key; ?> .a3-cycle-controls .cycle-pause {
<?php if ( $control_pause_icon != '' ) { ?>
    background-image: url("<?php echo $control_pause_icon; ?>");
<?php } ?>
}
.a3-rslider-<?php echo $template_key; ?> .a3-cycle-controls .cycle-play {

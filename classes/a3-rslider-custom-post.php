...
class A3_Responsive_Slider_Custom_Post
{
	...
	public static function register_post_type() {
		...
		register_taxonomy( 'slider_folder',
				...
				array(
					...
					'label' 				=> __( 'Folders', 'a3_responsive_slider'),
					'labels' => array(
							'name' 				=> __( 'Folders', 'a3_responsive_slider'),
							'singular_name' 	=> __( 'Folder', 'a3_responsive_slider'),
							'search_items' 		=> __( 'Search Folders', 'a3_responsive_slider'),
							'popular_items'		=> __( 'Popular Folders', 'a3_responsive_slider'),
							'parent_item'		=> __( 'Parent Folder', 'a3_responsive_slider'),
							'parent_item_colon'	=> __( 'Parent Folder:', 'a3_responsive_slider'),
							'all_items' 		=> __( 'All Folders', 'a3_responsive_slider'),
							'edit_item' 		=> __( 'Edit Folder', 'a3_responsive_slider'),
							'update_item' 		=> __( 'Update Folder', 'a3_responsive_slider'),
							'add_new_item' 		=> __( 'Add New Folder', 'a3_responsive_slider'),
							'new_item_name' 	=> __( 'New Folder Name', 'a3_responsive_slider')
						),
					'show_ui' 				=> true,
					'query_var' 			=> true,
		...
		$labels_array = array('name' => __( 'All Sliders', 'a3_responsive_slider'),
							  'singular_name' => __( 'Slider', 'a3_responsive_slider'),
							  'menu_name' => __( 'Responsive Slider', 'a3_responsive_slider'),
							  'all_items' => __( 'All Sliders', 'a3_responsive_slider'),
							  'add_new' => __( 'Add New Slider', 'a3_responsive_slider'),
							  'add_new_item' => __( 'Add New Slider', 'a3_responsive_slider'),
							  'edit' => __( 'Edit', 'a3_responsive_slider'),
							  'edit_item' => __( 'Edit Slider', 'a3_responsive_slider'),
							  'new_item' => __( 'New Slider', 'a3_responsive_slider'),
							  'view' => __( 'View', 'a3_responsive_slider'),
							  'view_item' => __( 'View Slider', 'a3_responsive_slider'),
							  'search_items' => __( 'Search Sliders', 'a3_responsive_slider'),
							  'not_found' => __( 'No Sliders Found', 'a3_responsive_slider'),
							  'not_found_in_trash' => __( 'No Sliders found in Trash', 'a3_responsive_slider'),
							  'parent' => __( 'Parent', 'a3_responsive_slider')
							 );
		...
		register_post_type( 'a3_slider',
							array('description' => __( 'Sliders Custom Post Type', 'a3_responsive_slider'),
								  'public' => false,
								  'show_ui' => true,
								  'show_in_menu' => true,
		...
		if ( $typenow == 'a3_slider' ) {
			...
			foreach ( $filters as $tax_slug ) {
				...
				echo "<select name='$tax_slug' id='$tax_slug' class='postform'>";
					echo "<option value=''>" . __( 'Show all folders', 'a3_responsive_slider' ) . "</option>";
				...
				if ( isset( $_GET['slider_folder'] ) && $_GET['slider_folder'] == '0' ) {
					echo "<option value='0' selected='selected'>" . __( 'Uncategorized', 'a3_responsive_slider' ) . " (".$the_query->found_posts.")</option>";	
				} else {
					echo "<option value='0'>" . __( 'Uncategorized', 'a3_responsive_slider' ) . " (".$the_query->found_posts.")</option>";
				}
				echo "</select>";
			}
			...
			echo "<option value=''>" . __( 'Show all skins', 'a3_responsive_slider' ) . "</option>";
	...
	public static function edit_columns( $columns ) {
		...
		$columns['image'] 			= __( 'Slider Thumbnail', 'a3_responsive_slider' );
		$columns['title'] 			= __( 'Name', 'a3_responsive_slider' );
		$columns['slider_skin'] 	= __( 'Skin', 'a3_responsive_slider' );
		$columns['cats'] 			= __( 'Folders', 'a3_responsive_slider' );
		$columns['date'] 			= __( 'Date', 'a3_responsive_slider' );
		$columns['count_images'] 	= __( 'Slides ', 'a3_responsive_slider' );
		...
		if ( $post_type == 'a3_slider' ) {
			...
			if ( ! empty( $slider_id ) ) {
				...
				$additional_action = array(
					'a3_slider_preview' => '<a class="preview-data thickbox" href="' . admin_url( 'admin-ajax.php', 'relative' ) . '?KeepThis=true&view=list&slider_id=' . $slider_id . '&action=a3_slider_preview&security=' . $a3_slider_preview . '&height=500" title="' . $post->post_title . ' - ' .esc_attr( __( 'Slider Preview', 'a3_responsive_slider' ) ) . '">' . __( 'Preview', 'a3_responsive_slider' ) . '</a>'
					);

...
class A3_Responsive_Slider_Template_Card_Dimensions_Settings extends A3_Responsive_Slider_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Dimensions Settings successfully saved.', 'a3_responsive_slider' ),
				'error_message'		=> __( 'Error: Dimensions Settings can not save.', 'a3_responsive_slider' ),
				'reset_message'		=> __( 'Dimensions Settings successfully reseted.', 'a3_responsive_slider' ),
			);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( 'Slider Type', 'a3_responsive_slider' ),
				...
				'checked_value'		=> 1,
				'unchecked_value'	=> 0,
				'checked_label'		=> __( 'Responsive', 'a3_responsive_slider' ),
				'unchecked_label' 	=> __( 'Fixed Wide', 'a3_responsive_slider' ),	
			),
			...
			array(  
				'name' 		=> __( 'Slider Size', 'a3_responsive_slider' ),
				'id' 		=> 'slider_size',
				'type' 		=> 'array_textfields',
				'ids'		=> array( 
	 								array( 
											'id' 		=> 'slider_width',
	 										'name' 		=> __( 'Width', 'a3_responsive_slider' ),
	 										'css'		=> 'width:40px;',
	 										'default'	=> 300 ),
	 
	 								array(  'id' 		=> 'slider_height',
	 										'name' 		=> __( 'Height', 'a3_responsive_slider' ),
	 										'css'		=> 'width:40px;',
	 										'default'	=> 250 ),
	 							)
			),
			...
			array(  
				'name' 		=> __( 'Wide', 'a3_responsive_slider' ),
				'desc'		=> '%',
			...
			array(  
				'name' 		=> __( 'Tall Type', 'a3_responsive_slider' ),
				...
				'checked_value'		=> 0,
				'unchecked_value'	=> 1,
				'checked_label'		=> __( 'Fixed', 'a3_responsive_slider' ),
				'unchecked_label' 	=> __( 'Dynamic', 'a3_responsive_slider' ),	
			),

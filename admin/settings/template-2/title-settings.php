...
class A3_Responsive_Slider_Template_2_Title_Settings extends A3_Responsive_Slider_Admin_UI
{
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( 'Title Container Maximum Wide', 'a3_responsive_slider' ),
				'desc'		=> '%',
				'id' 		=> 'title_wide',
				'type' 		=> 'slider',
				'default'	=> 60,
			...
			array(  
				...
				'id' 		=> 'title_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '18px', 'face' => 'Arial, sans-serif', 'style' => 'bold', 'color' => '#FFFFFF' )
			),
			array(  
			...
			array(  
				'name' 		=> __( 'Title Container Background Colour', 'a3_responsive_slider' ),
			...
			array(  
				'name' 		=> __( 'Title Container Background Transparency', 'a3_responsive_slider' ),
			...
			array(  
				'name' 		=> __( 'Title Container Border', 'a3_responsive_slider' ),
				'id' 		=> 'title_border',
				'type' 		=> 'border',
				'default'	=> array( 'width' => '0px', 'style' => 'solid', 'color' => '#000000', 'corner' => 'rounded' , 'rounded_value' =>4 )
			),
			array(  
				'name' 		=> __( 'Title Container Shadow', 'a3_responsive_slider' ),
				'id' 		=> 'title_shadow',
				'type' 		=> 'box_shadow',

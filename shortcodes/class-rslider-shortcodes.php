...
class A3_Responsive_Slider_Shortcode
{
	...
	public function add_rslider_button() {
		...
		echo '<a href="#TB_inline?width=640&height=500&inlineId=a3-rslider-wrap" class="thickbox button a3-rslider-add-shortcode" title="' . __( 'Insert shortcode', 'a3_responsive_slider' ) . '"><span class="a3-rslider-add-shortcode_icon"></span>'.__( 'Sliders', 'a3_responsive_slider' ).'</a>';
	}
	...
	public function rslider_generator_popup() {
		...
		<div id="a3-rslider-wrap" style="display:none">
        	...
        	<fieldset style="border:1px solid #DFDFDF; padding:0 20px; background: #FFF; margin-top:15px;"><legend style="font-weight:bold; font-size:14px;"><?php _e( 'Insert Responsive Slider', 'a3_responsive_slider' ); ?></legend>
            <div id="a3-rslider-content" class="a3-rslider-content a3-rslider-shortcode-popup-container" style="text-align:left;">
                <p><label for="rslider_id"><?php _e( 'Select Slider', 'a3_responsive_slider' ); ?>:</label> 
                    <select style="width:300px" id="rslider_id" name="rslider_id">
                    <?php
					echo '<option value="">'.__( 'Please select...', 'a3_responsive_slider' ).'</option>';	
                ...
                <p><label for="rslider_description"><?php _e( 'Description', 'a3_responsive_slider' ); ?>:</label> <textarea style="width:100%; height:60px" id="rslider_description" name="rslider_description" placeholder="<?php _e( 'Enter the description that show at bottom of Slider', 'a3_responsive_slider' ); ?>"></textarea></p>
                <p><label for="rslider_align"><?php _e( 'Slider Alignment', 'a3_responsive_slider' ); ?>:</label> 
                <select style="width:120px" id="rslider_align" name="rslider_align">
                	<option value="none" selected="selected"><?php _e( 'None', 'a3_responsive_slider' ); ?></option>
                    <option value="left-wrap"><?php _e( 'Left - wrap', 'a3_responsive_slider' ); ?></option>
                    <option value="left"><?php _e( 'Left - no wrap', 'a3_responsive_slider' ); ?></option>
                    <option value="center"><?php _e( 'Center', 'a3_responsive_slider' ); ?></option>
                    <option value="right-wrap"><?php _e( 'Right - wrap', 'a3_responsive_slider' ); ?></option>
                    <option value="right"><?php _e( 'Right - no wrap', 'a3_responsive_slider' ); ?></option>
                </select> <span class="description"><?php _e( 'Wrap is text wrap like images', 'a3_responsive_slider' ); ?></span></p>
				<p><label for="rslider_width"><?php _e( 'Slider Width', 'a3_responsive_slider' ); ?>:</label> <input style="width:50px;" size="10" id="rslider_width" name="rslider_width" type="text" value="300" /> 
                <select style="width:60px" id="rslider_width_type" name="rslider_width_type">
                	<option value="px" selected="selected">px</option>
                    <option value="%">%</option>
                </select>
                </p>
                <p><label for="rslider_tall_type"><?php _e( 'Slider Tall Type', 'a3_responsive_slider' ); ?>:</label> 
                <label style="width:auto; float:none"><input type="radio" name="rslider_tall_type" class="rslider_tall_type" id="rslider_tall_type_fixed" value="fixed" checked="checked" /> <?php _e( 'Fixed', 'a3_responsive_slider' ); ?></label> &nbsp;&nbsp;&nbsp;
                <label style="width:auto; float:none"><input type="radio" name="rslider_tall_type" class="rslider_tall_type" id="rslider_tall_type_dynamic" value="dynamic" /> <?php _e( 'Dynamic', 'a3_responsive_slider' ); ?></label>
                </p>
                <p class="rslider_tall_type_fixed_container"><label for="rslider_height"><?php _e( 'Slider Height', 'a3_responsive_slider' ); ?>:</label> <input style="width:50px;" size="10" id="rslider_height" name="rslider_height" type="text" value="250" /> px
                </p>
                <p><label for=""><strong><?php _e( 'Slider Margin', 'a3_responsive_slider' ); ?></strong>:</label><br /> 
                        <label for="rslider_margin_top" style="width:auto; float:none"><?php _e( 'Above', 'a3_responsive_slider' ); ?>:</label><input style="width:50px;" size="10" id="rslider_margin_top" name="rslider_margin_top" type="text" value="10" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="rslider_margin_bottom" style="width:auto; float:none"><?php _e( 'Below', 'a3_responsive_slider' ); ?>:</label> <input style="width:50px;" size="10" id="rslider_margin_bottom" name="rslider_margin_bottom" type="text" value="10" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="rslider_margin_left" style="width:auto; float:none"><?php _e( 'Left', 'a3_responsive_slider' ); ?>:</label> <input style="width:50px;" size="10" id="rslider_margin_left" name="rslider_margin_left" type="text" value="10" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="rslider_margin_right" style="width:auto; float:none"><?php _e( 'Right', 'a3_responsive_slider' ); ?>:</label> <input style="width:50px;" size="10" id="rslider_margin_right" name="rslider_margin_right" type="text" value="10" />px
                </p>
                <p><label for=""><strong><?php _e( 'Description Container Margin', 'a3_responsive_slider' ); ?></strong>:</label><br /> 
                        <label for="rs_desc_margin_top" style="width:auto; float:none"><?php _e( 'Above', 'a3_responsive_slider' ); ?>:</label><input style="width:50px;" size="10" id="rs_desc_margin_top" name="rs_desc_margin_top" type="text" value="10" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="rs_desc_margin_bottom" style="width:auto; float:none"><?php _e( 'Below', 'a3_responsive_slider' ); ?>:</label> <input style="width:50px;" size="10" id="rs_desc_margin_bottom" name="rs_desc_margin_bottom" type="text" value="10" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="rs_desc_margin_left" style="width:auto; float:none"><?php _e( 'Left', 'a3_responsive_slider' ); ?>:</label> <input style="width:50px;" size="10" id="rs_desc_margin_left" name="rs_desc_margin_left" type="text" value="10" />px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="rs_desc_margin_right" style="width:auto; float:none"><?php _e( 'Right', 'a3_responsive_slider' ); ?>:</label> <input style="width:50px;" size="10" id="rs_desc_margin_right" name="rs_desc_margin_right" type="text" value="10" />px
                </p>
			</div>
            <div style="clear:both;height:0px"></div>
            <p><input type="button" class="button button-primary" value="<?php _e( 'Insert Shortcode', 'a3_responsive_slider' ); ?>" onclick="a3_rslider_add_shortcode();"/> 
            <input type="button" class="button" onclick="tb_remove(); return false;" value="<?php _e('Cancel', 'a3_responsive_slider'); ?>" />
			</p>
            </fieldset>
		...
		function a3_rslider_add_shortcode(){
			...
			if (selected_rslider_id == '') {
				alert('<?php _e( 'Please select Slider', 'a3_responsive_slider' ); ?>');
				return false;	
			}
			...
			foreach ( $all_post_types as $post_type => $post_type_data ) {
				...
				?>
                	<div class="a3rev_panel_inner">
                    	<h3><?php _e( 'All', 'a3_responsive_slider' ); ?> <?php echo $post_type_data->labels->name; ?> <?php _e( 'have this slider is embed into content', 'a3_responsive_slider' ); ?></h3>
                            ...
                            <tr valign="top">
                                <td class="forminp forminp-text">
                                    <div class="a3_slider_used_on_post a3_slider_used_on_post_<?php echo $my_post->ID; ?>">
                                    	<span title="<?php _e( 'Remove the shortcode from the content of this post', 'a3_responsive_slider' ); ?>" href="#" class="a3_slider_remove_shortcode" slider-id="<?php echo $slider_id; ?>" post-id="<?php echo $my_post->ID; ?>" >[<?php _e( 'Remove Shortcode', 'a3_responsive_slider' ); ?>]</span> 

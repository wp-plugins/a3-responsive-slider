...
class A3_Responsive_Slider_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'a3_rslider_widget', 'description' => __( "Use this widget to add A3 responsive slider as a widget.", 'a3_responsive_slider' ) );
		parent::__construct('a3_rslider_widget', __( 'a3 Responsive Slider', 'a3_responsive_slider' ), $widget_ops);
	}
...
?>
		<p>
        	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Title', 'a3_responsive_slider' ); ?>:</label>
        ...
        <p>
			...
			?>
        	<label for="<?php echo $this->get_field_id('slider_id'); ?>"><?php _e( 'Select Slider', 'a3_responsive_slider' ); ?>:</label>
